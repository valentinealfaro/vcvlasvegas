    ...
    <div className="fixed inset-x-0 bottom-0 z-40 lg:hidden">
      ...
      <div className="grid grid-cols-2 bg-ink/95 backdrop-blur-xl">
        <a
          ...
          className="group flex items-center justify-center gap-2 py-4 text-[0.7rem] font-medium uppercase tracking-[0.24em] text-bone transition-colors active:bg-ink-700"
        >
