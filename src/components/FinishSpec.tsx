...
export function FinishSpec({
  ...
  return (
    <section className="relative overflow-hidden bg-bone-800 py-24 lg:py-32">
          ...
          {specs.map((s, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-[0.6rem] uppercase tracking-[0.28em] text-ink/40">
              ...
              <p className="mt-4 font-display text-2xl text-ink transition-all duration-500 group-hover:[text-shadow:0_0_20px_rgba(252,187,0,0.35)]">
                {s.label}
              </p>
              <span
                aria-hidden
              ...
              />
              <p className="mt-4 text-sm leading-relaxed text-ink/65 transition-colors duration-500 group-hover:text-ink/85">
                {s.description}
              </p>
            </Reveal>
          ))}
