...
export function LegalLayout({
  ...
  return (
    <article className="bg-bone py-32 lg:py-40">
      <div className="container-luxe">
        <div className="mx-auto max-w-3xl">
          <Reveal>
            ...
            <h1 className="font-display text-4xl text-ink text-balance md:text-5xl">
              {title}
              {italic && (
                <>
                  {' '}
          ...
          <div className="mt-16 space-y-12">
            {sections.map((s, i) => (
              <Reveal key={s.id ?? s.heading} delay={i % 3}>
                <section id={s.id} className="border-t border-ink/10 pt-10">
