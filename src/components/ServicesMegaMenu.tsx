      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-x-0 top-[72px] z-40 border-y border-bone/10 bg-ink/95 backdrop-blur-xl"
          >
            <div className="container-luxe py-12">
              <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr]">
                ...
                <div className="relative hidden aspect-[4/3] overflow-hidden bg-ink-700 lg:block">
