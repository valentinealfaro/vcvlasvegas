        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <Reveal>
            <div className="border-gradient">
              <div className="relative aspect-[4/5] overflow-hidden bg-bone-700">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-bone/85 via-bone/30 to-transparent" />
                {/* Gold corner ticks */}
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-8 lg:p-12">
                  <div className="flex items-center gap-3 text-ink">
                    ...
                    <p className="eyebrow !text-ink/85">Studio Brief · 2026</p>
                  </div>
                  <div>
                    <p className="font-display text-3xl text-ink md:text-5xl">
                      The Las Vegas
                      <br />
                      <span className="italic text-ink">Luxury Remodel</span>
                      <br />
                      Investment Guide.
                    </p>
                  </div>
          ...
          <Reveal delay={1}>
            ...
            <h2 className="font-display text-4xl text-ink text-balance md:text-5xl">
              ...
              <span className="italic text-ink">actually costs.</span>
            </h2>
            ...
            <ul className="mt-8 space-y-3 border-y border-ink/10 py-7">
              {includes.map((item, i) => (
                <li key={item} className="group flex items-center gap-3 text-sm text-ink/75 transition-colors duration-500 hover:text-ink">
                  <span
                    aria-hidden
              ...
              >
                <label className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full border border-ink/15 bg-bone/70 py-4 pl-12 pr-4 text-ink placeholder:text-ink/40 focus:border-gold focus:outline-none"
                  />
                </label>
