      ...
      <div className="container-luxe py-20 lg:py-24">
        <div className="grid gap-14 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-bone/70">
              ...
              <li><Link href="/principles" className="link-quiet hover:text-gold">Principles</Link></li>
              ...
              <li><Link href="/spec-sheet" className="link-quiet hover:text-gold">Specification Sheet</Link></li>
              <li><Link href="/glossary" className="link-quiet hover:text-gold">Glossary</Link></li>
              ...
              <li><Link href="/sample-budgets" className="link-quiet hover:text-gold">Sample Budgets</Link></li>
              <li><Link href="/before-you-start" className="link-quiet hover:text-gold">Before You Start</Link></li>
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-bone/10 pt-8 text-xs uppercase tracking-[0.22em] text-bone/40 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            <Link href="/privacy" className="link-quiet text-bone/45 hover:text-gold">
              Privacy
            </Link>
            <Link href="/terms" className="link-quiet text-bone/45 hover:text-gold">
              Terms
            </Link>
            <Link href="/accessibility" className="link-quiet text-bone/45 hover:text-gold">
              Accessibility
            </Link>
