...
export default function AboutPage() {
  return (
    <>
            ...
            <Reveal>
              <div>
                ...
                <h2 className="font-display text-4xl text-ink md:text-6xl">
                  ...
                  <span className="italic text-ink">actually admire.</span>
                </h2>
              </div>
            </Reveal>
            <Reveal delay={1}>
              <div className="space-y-6 text-lg leading-relaxed text-ink/70 md:text-xl">
                <p>
      ...
      {/* Numbers band */}
      <section className="relative overflow-hidden border-y border-ink/8 bg-bone py-20">
            ...
            {[
              ...
              <Reveal key={stat.l} delay={i}>
                <div className="group relative pl-4">
                  ...
                  />
                  <p className="font-display text-5xl text-ink transition-all duration-500 group-hover:[text-shadow:0_0_24px_rgba(252,187,0,0.45)] md:text-6xl">
                    {stat.n}
                  </p>
                  <div className="mt-3 flex items-center gap-2">
                    ...
                    <p className="max-w-[18ch] text-sm uppercase tracking-[0.22em] text-ink/55 transition-colors duration-500 group-hover:text-ink/80">
                      {stat.l}
                    </p>
                  </div>
                </div>
      ...
      <section className="bg-bone py-24 lg:py-32">
        <div className="container-luxe">
          ...
          />
          <div className="mt-20 grid gap-px bg-ink/10 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                t: 'Senior-Led',
              ...
              <Reveal key={v.t} delay={i % 3} className="group relative overflow-hidden bg-bone p-8 transition-colors duration-500 hover:bg-bone-700 lg:p-10">
                {/* Hover sweep */}
                <span
                  aria-hidden
        ...
        <div className="container-luxe">
          <div className="relative mx-auto max-w-4xl">
            ...
            <Reveal>
              ...
              <figcaption className="mt-8 flex items-center gap-3 text-[0.65rem] uppercase tracking-[0.28em] text-ink">
