          ...
          <div className="grid items-start gap-10 lg:grid-cols-[1fr_2fr] lg:gap-16">
            <Reveal>
              <div className="flex items-center gap-4">
                ...
                <p className="eyebrow !text-ink">Press Contact</p>
              </div>
            </Reveal>
            <Reveal delay={1}>
              <div>
                <p className="font-display text-3xl text-ink text-balance md:text-4xl">
                  ...
                  <a
                    ...
                    className="italic text-ink underline-offset-4 hover:underline"
                  >
                    {siteConfig.email}
                  </a>
                  .
                </p>
                <p className="mt-5 text-ink/55 md:text-lg">
        ...
        <div className="container-luxe">
          ...
          <div className="mt-16 grid gap-px bg-ink/10 md:grid-cols-3">
            {available.map((a, i) => {
              const Icon = a.icon;
              return (
                <Reveal key={a.t} delay={i} className="bg-bone p-8 lg:p-10">
                  <Icon className="h-6 w-6 text-ink" />
                  <p className="mt-6 font-display text-xl text-ink md:text-2xl">
                    {a.t}
                  </p>
          ...
          <div className="mt-16 grid gap-3 md:grid-cols-2">
            {beats.map((beat, i) => (
              <Reveal key={beat} delay={i % 2}>
                <div className="flex items-start gap-4 border-t border-ink/10 pt-5 text-base text-ink/75 md:text-lg">
